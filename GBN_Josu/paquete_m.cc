...
unsigned int paquete::getNumSeq() const
{
    return this->numSeq;
}

void paquete::setNumSeq(unsigned int numSeq)
{
    this->numSeq = numSeq;
}
...
std::string paqueteDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    paquete *pp = (paquete *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->getNumSeq());
        default: return "";
    }
}
...
bool paqueteDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    paquete *pp = (paquete *)object; (void)pp;
    switch (field) {
        case 0: pp->setNumSeq(string2ulong(value)); return true;
